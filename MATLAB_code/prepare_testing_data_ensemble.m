...
for i = 1:length(psg_fnames)
   ...
   testinput=[testinput;input_preson];
   testoutput = [testoutput;output_person];
end
save(fullfile(output_dir,"testing_data_ensemble.mat"),"testinput","testoutput")
